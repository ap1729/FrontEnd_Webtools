...
*/
func CDF(sc *model.Scenario, intrCancelCount uint) map[string]interface{} {
var cdfL0Obj,cdfL1Obj cdfL0L1Ret
returnData := map[string]interface{}{}
fmt.Println("CDF func reached")

cdfL0Obj=cdfL0L1(sc,uint(0),intrCancelCount)
cdfL1Obj=cdfL0L1(sc,uint(1),intrCancelCount)
...
func cdfL0L1(temp *model.Scenario,  levelValue uint, intfCancelCount uint) cdfL0L1Ret{
...
for userId:=0;userId<numUeCdf;userId++{
        intStatIds := intrStations("FR1", temp, uint(userId), nil)
